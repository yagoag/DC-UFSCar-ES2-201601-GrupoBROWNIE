...
import net.sf.jabref.importer.csvimport.CsvImporter;
...
public class CsvImporterTest {
    ...
    public void testGetFormatName() {
        CsvImporter importer = new CsvImporter();
        Assert.assertEquals("CSV Importer", importer.getFormatName());
    }

    @Test
    public void testGetExtensions() {
        CsvImporter importer = new CsvImporter();
        Assert.assertEquals("csvimporter", importer.getCLIId());
    }
